...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SERACH_QUERY_KEY = "query";

    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String SEARCH_RESULTS_KEY = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(SERACH_QUERY_KEY)) {
                mUrlDisplayTextView.setText(savedInstanceState.getString(SERACH_QUERY_KEY));
            }

            if (savedInstanceState.containsKey(SEARCH_RESULTS_KEY)) {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SERACH_QUERY_KEY, queryUrl);
        ...
        outState.putString(SEARCH_RESULTS_KEY, searchResults);
    }
}